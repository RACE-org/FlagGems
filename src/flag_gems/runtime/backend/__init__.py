...
def import_vendor_extra_lib(vendor_name=None):
    ...
    try:
        ...
        print(f"!!!!!!【info】import_module _{vendor_name}.ops success!!!!!!")
    except Exception:
        print(f"!!!!!!【warn】import_module _{vendor_name}.ops failed, regress to use flag_gems.ops!!!!!!")
        pass
    try:
        fused_module = importlib.import_module(f"_{vendor_name}.fused")
        print(f"!!!!!!【info】import_module _{vendor_name}.fused success!!!!!!")
    except Exception:
        print(f"!!!!!!【warn】import_module _{vendor_name}.fused failed, regress to use flag_gems.fused!!!!!!")
        pass
